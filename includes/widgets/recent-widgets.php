...
class okay_recent_widgets extends WP_Widget {
	...
	parent::__construct( 'ok-recent-widgets', __('Okay Recent Posts Widget', 'ok-recent-widgets'), $widget_ops, $control_ops );
	}
...
?>
		...
		<div class="okay-recent-posts">
			<ul class="tab-wrapper tabs">
				<li><a class="current" href="#"><i class="fa fa-file-text-o"></i></a></li>
				<li><a class="" href="#"></span><i class="fa fa-heart"></i></a></li>
				<li><a class="" href="#"><i class="fa fa-comment"></i></a></li>
				<li><a class="" href="#"><i class="fa fa-tag"></i></a></li>
